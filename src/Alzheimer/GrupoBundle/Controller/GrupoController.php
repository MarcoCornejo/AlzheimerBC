...
use Alzheimer\GrupoBundle\Entity\Grupo;
use Alzheimer\GrupoBundle\Form\GrupoType;
...
class GrupoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GrupoBundle:Grupo')->findAll();
     ...
     * @Method("POST")
     * @Template("GrupoBundle:Grupo:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GrupoBundle:Grupo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GrupoBundle:Grupo:edit.html.twig")
     */
